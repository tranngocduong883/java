...
public class jfqlhdn extends javax.swing.JFrame {
...
public void loadTable() {
    try {
        ...
        List<HoaDonNhap> list = dao.getAll(); // đảm bảo getAll() trả List<HoaDonNhap>

        // Tạo model mới để tránh lỗi cast hoặc model cũ không khớp
        DefaultTableModel model = new DefaultTableModel(
            new Object[]{"Mã HDN", "Mã giày", "Mã nhân viên", "Ngày nhập", "Đơn giá nhập", "Số lượng nhập", "Thành tiền"}, 
            0
        );
        jTable1.setModel(model); // set model mới an toàn

        for (HoaDonNhap h : list) {
            double thanhTien = h.getSoLuongN() * h.getDonGiaN();

            model.addRow(new Object[]{
                h.getMaHDN(),
                h.getMaGiay(),
                "",                // Mã nhân viên: nếu không lưu, để trống
                h.getNgayN(),
                h.getDonGiaN(),
                h.getSoLuongN(),
                thanhTien
        ...
        // javax.swing.JOptionPane.showMessageDialog(this, "Lỗi load bảng: " + ex.getMessage());
    }
}
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã HDN", "Mã giày", "Mã nhân viên", "Ngày nhập", "Đơn giá nhập", "Số lượng nhập", "Thành tiền"
            }
        ) {
        ...
        jLabel1.setText(" QUẢN LÝ HOÁ ĐƠN NHẬP");
        ...
        jLabel2.setText("Mã hoá đơn nhập");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jfqlhdn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
